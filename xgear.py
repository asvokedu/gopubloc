            ...
            try:
                ...
                for symbol in self.symbols:
                    ...
                    try:
                        ...
                        if btc_recommendation == 'LONG' and btc_index_val > 0.06 and btc_index_val <= 0.50:
                            score += 3
                        elif btc_recommendation != 'LONG' and btc_index_val > 0.1 and btc_index_val <= 0.50:
                            score += 3
                        elif btc_recommendation == 'SHORT' and btc_index_val < -0.06 and btc_index_val >= -0.50:
                            score -= 3
                        elif btc_recommendation != 'SHORT' and btc_index_val < -0.1 and btc_index_val >= -0.50:
                            score -= 3
                        elif btc_index_val < -0.50:
                            score += 3
                        elif btc_index_val > 0.50:
                            score -= 3     
